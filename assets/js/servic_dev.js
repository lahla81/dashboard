$(document).ready(function () {
    ...
    $('#customCheck_comerc:input').click(function() {
        myChart.destroy();
        var advertise_data = document.getElementById("bar-chart");
        const data   = JSON.parse(advertise_data.parentElement.dataset.comerc);
        const labels = JSON.parse(advertise_data.parentElement.dataset.labels);
    ...
    $('#customCheck_workers:input').click(function() {
        myChart.destroy();
        var advertise_data = document.getElementById("bar-chart");
        const data   = JSON.parse(advertise_data.parentElement.dataset.workers);
        const labels = JSON.parse(advertise_data.parentElement.dataset.labels);
    ...
    $('#customCheck_abu_extr:input').click(function () {
        myChart.destroy();
        var advertise_data = document.getElementById("bar-chart");
        const data   = JSON.parse(advertise_data.parentElement.dataset.abu_extr);
        const labels = JSON.parse(advertise_data.parentElement.dataset.labels);
    ...
    $('#customCheck_rent:input').click(function () {
        myChart.destroy();
        var advertise_data = document.getElementById("bar-chart");
        const data   = JSON.parse(advertise_data.parentElement.dataset.rent);
        const labels = JSON.parse(advertise_data.parentElement.dataset.labels);
    ...
    $('#customCheck_eye_adv:input').click(function() {
        myChart.destroy();
        var advertise_data = document.getElementById("bar-chart");
        const data   = JSON.parse(advertise_data.parentElement.dataset.eye_adv);
        const labels = JSON.parse(advertise_data.parentElement.dataset.labels);
    ...
    $('#customCheck_yahr_adv:input').click(function() {
        myChart.destroy();
        var advertise_data = document.getElementById("bar-chart");
        const data   = JSON.parse(advertise_data.parentElement.dataset.yahr_adv);
    ...
    $('#customCheck_zafra_adv:input').click(function() {
        myChart.destroy();
        var advertise_data = document.getElementById("bar-chart");
        const data   = JSON.parse(advertise_data.parentElement.dataset.zafra_adv);
    ...
    $('#customCheck_roways_adv:input').click(function() {
        myChart.destroy();
        var advertise_data = document.getElementById("bar-chart");
        const data1   = JSON.parse(advertise_data.parentElement.dataset.veto);
        const data2   = JSON.parse(advertise_data.parentElement.dataset.abu_inter);
        const data3   = JSON.parse(advertise_data.parentElement.dataset.comerc);
        const data4   = JSON.parse(advertise_data.parentElement.dataset.workers);
        const data5   = JSON.parse(advertise_data.parentElement.dataset.abu_extr);
        const data6   = JSON.parse(advertise_data.parentElement.dataset.rent);
        const data7   = JSON.parse(advertise_data.parentElement.dataset.eye_adv);
        const data8   = JSON.parse(advertise_data.parentElement.dataset.yahr_adv);
        const data9   = JSON.parse(advertise_data.parentElement.dataset.zafra_adv);

        const sum = [];
        for(var i = 0; i < data1.length; i++){
            sum.push(data1[i] + data2[i] + data3[i] + data4[i] + data5[i] + data6[i] + data7[i] + data8[i] + data9[i]);
        }
