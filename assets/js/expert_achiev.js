$(document).ready(function () {
    ...
    $('input[name="notary"]').click(function(){
        ...
        if(checked == "sum_all"){
            ...
            persentage3 = count3 * 100 / count5;
            persentage3 = Math.round(persentage3);
            
            value.splice(2, 0, count1);
            value.splice(3, 0, persentage1);
            value.splice(6, 0, count2);
            value.splice(7, 0, persentage2);
            value.push(count3);
            value.push(count4);
            value.push(count5);
            value.push(persentage3);
