$(document).ready(function () {
    ...
    const abu_data   = JSON.parse(clinic_chart.parentElement.dataset.abu);
    ...
    $('#customCheck_eye:input').click(function () {
        myChart.destroy();
        var clinic_chart = document.getElementById("bar-chart");
        const eye_data   = JSON.parse(clinic_chart.parentElement.dataset.eye);
        const labels = JSON.parse(clinic_chart.parentElement.dataset.labels);
    ...
    $('#customCheck_sum:input').click(function() {
        ...
        var sum = abu_data.map(function (num, idx) {
            return num + eye_data[idx];
            });
        sum[2] = (sum[0] + sum[1]);
