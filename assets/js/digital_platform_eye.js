$(document).ready(function () {
    ...
    var digital_platform_eye_bar = document.getElementById("digital_platform_eye_bar");
    const digital_data = JSON.parse(digital_platform_eye_bar.parentElement.dataset.values);
    ...
    // bar Chart
    var digital_platform_eye = document.getElementById("digital_platform_eye");
        var ctx =  digital_platform_eye.getContext('2d');
    ...
    $('#customCheck-line:input').click(function(){
        ...
        var ctx = document.getElementById("digital_platform_eye_line").getContext('2d');
    ...
    $('#customCheck-half:input').click(function(){
        for (i = 0; i < 7 ; i++) {
            var id = "digital_platform_eye_half" + i;
    ...
    $('#customCheck-circle:input').click(function(){
        for (i = 0; i < 7 ; i++) {
            var id = "#digital_platform_eye_circle" + i;
